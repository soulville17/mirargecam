...
const features = [
  { icon: Zap, title: "Transformation temps reel", description: "Face swap instantane sans latence" },
  { icon: Monitor, title: "Camera virtuelle", description: "Utilisez MirageCam dans Zoom, Teams, WhatsApp" },
  { icon: Shield, title: "100% Prive", description: "Tout est traite localement sur votre PC" },
  { icon: Cpu, title: "GPU Accelere", description: "Utilise votre carte graphique pour des performances optimales" }
]
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              L&apos;application de transformation faciale en temps reel pour votre ordinateur.
              Transformez-vous pendant vos appels video!
            </p>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="bg-gradient-to-r from-[#00ff88]/10 to-transparent border border-[#00ff88]/30 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ol className="space-y-3 text-gray-300">
                  <li className="flex gap-3"><span className="flex-shrink-0 w-6 h-6 bg-[#00ff88] rounded-full flex items-center justify-center text-black text-sm font-bold">1</span><span>Ouvrez le fichier .dmg telecharge</span></li>
                  <li className="flex gap-3"><span className="flex-shrink-0 w-6 h-6 bg-[#00ff88] rounded-full flex items-center justify-center text-black text-sm font-bold">2</span><span>Glissez MirageCam dans le dossier Applications</span></li>
                  <li className="flex gap-3"><span className="flex-shrink-0 w-6 h-6 bg-[#00ff88] rounded-full flex items-center justify-center text-black text-sm font-bold">3</span><span>Ouvrez MirageCam et autorisez l&apos;acces a la camera</span></li>
                </ol>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-[#00ff88] mb-4">Windows</h3>
                <ol className="space-y-3 text-gray-300">
                  <li className="flex gap-3"><span className="flex-shrink-0 w-6 h-6 bg-[#00ff88] rounded-full flex items-center justify-center text-black text-sm font-bold">1</span><span>Executez le fichier .exe telecharge</span></li>
                  <li className="flex gap-3"><span className="flex-shrink-0 w-6 h-6 bg-[#00ff88] rounded-full flex items-center justify-center text-black text-sm font-bold">2</span><span>Suivez l&apos;assistant d&apos;installation</span></li>
                  <li className="flex gap-3"><span className="flex-shrink-0 w-6 h-6 bg-[#00ff88] rounded-full flex items-center justify-center text-black text-sm font-bold">3</span><span>Lancez MirageCam depuis le menu Demarrer</span></li>
                </ol>
              </div>
            </div>
          </motion.div>

          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }} className="text-center mt-12 text-gray-500">
